    ...
    <div class="row">
        <div class="col-sm-12 col-lg-12 col-md-12" style="width: unset;overflow:hidden;">
            ...
            <div class="container mt_75 sm">
                <div class="div_title">Our Projects</div>
                <div class="mt_20 project_tabs">
                    <ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" href="#web_design">Web Design</a></li>
                        <li><a data-toggle="tab" href="#mobileapp_design">Mobile App Design</a></li>
                        <li><a data-toggle="tab" href="#freebies">Freebies</a></li>
                    </ul>
