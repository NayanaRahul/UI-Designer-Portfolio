                    ...
                    <nav class="navbar navbar-expand-md navbar-expand-lg ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarDropdown">
                            <ul class="navbar-nav home_menu ml-lg-auto mr-auto">
                                <li class="nav-item wow fadeInDown" data-wow-delay="0.25s"><a href="home.php" class="nav-link">Home</a></li>
                                <li class="nav-item wow fadeInDown" data-wow-delay="0.45s"><a href="about.php" class="nav-link">About</a></li>
                                <li class="nav-item wow fadeInDown" data-wow-delay="0.65s"><a href="projects.php" class="nav-link active">Project</a></li>
                                <li class="nav-item wow fadeInDown" data-wow-delay="0.75s"><a href="about.php?u=contact" class="nav-link">Contact</a></li>
                            </ul>
                        </div>
                    </nav>
                    <div class="container">
                        <div class="text_grey fs_18 lh_30">Case Study</div>
                        <div class="fs_48 lh_62">Ant - Personal Portofolio</div>
                        <div class="flexbox_container mt_20">
                            <div>
                                <p class="fs_24 lh_36 font-weight-bold">2020</p>
                                <p class="fs_16 text_grey">Year</p>
                            </div>
                            <div class="ml-5">
                                <p class="fs_24 lh_36 font-weight-bold">Kathryn Murphy</p>
                                <p class="fs_16 text_grey">Client</p>
                            </div>
                        </div>
                    </div>
                    <div class="container">
