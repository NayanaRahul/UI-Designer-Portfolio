                ...
                <nav class="navbar navbar-expand-md navbar-expand-lg ">
                    ...
                    <div class="collapse navbar-collapse" id="navbarDropdown">
                        <ul class="navbar-nav home_menu ml-lg-auto mr-auto">
                            ...
                            <li class="nav-item wow fadeInDown" data-wow-delay="0.45s"><a href="about.php" class="nav-link active">About</a></li>
                ...
                <div class="suggestion_form flexbox_container justify-content-between" id="contact_form">
                    ...
                    <div class="form">
                        ...
                        <form>
                            ...
                            <button type="submit" class=" btn_normal float-right"><b>Email Me</b></button>
                        </form>
                    </div>
                </div>
            </div>
